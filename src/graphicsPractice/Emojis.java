...
public class Emojis {
    ...
    public static GraphicsGroup createSmileyFace(double size) {
        ...
        Ellipse lefteye = createEye(size*0.15, size*0.15);
        lefteye.setCenter(size * 0.3, size * 0.4);
        group.add(lefteye);

        Ellipse righteye = createEye(size*0.15, size*0.15);
        righteye.setCenter(size * 0.7, size * 0.4);
        group.add(righteye);
    ...
    public static GraphicsGroup createWinkingFace(double size) {
        ...
        Line righteye = createWink (size* 0.15, size * 0.15);
        righteye.setStartPosition(size * 0.7, size * 0.4);
        righteye.setEndPosition(size*0.85, size*0.4);
        group.add(righteye);
    ...
    private static Line createWink(double height, double width){
        Line eye = new Line (0, 0, width, height);
